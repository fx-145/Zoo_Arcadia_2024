                        ...
                        <tr>
                            ...
                            <td>
                                <form action="crud_homes_update" method="post" style="display:inline;">
                                    <input type="hidden" name="home_id" value="<?php echo htmlspecialchars($row['home_id'], ENT_QUOTES, 'UTF-8'); ?>">
                                    <button type="submit" name="submit_update_home" class="btn btn-success btn-custom mr-2">Modifier</button>
                                </form>
                                <br><br>
                                <form action="crudHomeHandler" method="post" style="display:inline;">
                                    <input type="hidden" name="home_id" value="<?php echo htmlspecialchars($row['home_id'], ENT_QUOTES, 'UTF-8'); ?>">
                                    <button type="submit" name="submit_delete_home" class="btn btn-danger btn-custom ml-2">Supprimer</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
