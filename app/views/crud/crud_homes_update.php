    ...
    <body>
        ...
        <div class="container-fluid py-5 main-content">
            ...
            <form action="crudHomeHandler" method="post">
                ...
                <a href="crud_homes" class="btn btn-secondary ml-2">Annuler</a>
            </form>
            <hr>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($resultPics as $row): ?>
                            <tr>
                                <td><img src="<?php echo "../../" . htmlspecialchars($row['home_picture_path'], ENT_QUOTES, 'UTF-8'); ?>"
                                        alt="Photo de l'habitat" class="img-fluid" width="200"></td>
                                <td>
                                    ...
                                    <input type="hidden" name="home_picture_id"
