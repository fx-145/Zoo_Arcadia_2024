    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
      <div class="card h-100">
        <div class="card-body main-content">
          ...
          <p class="card-text">Le Zoo Arcadia est situé en France, à Paimpont près de la forêt de Brocéliande, en Bretagne depuis 1960. Nous avons le souci permanent du bien-être de nos animaux. Le zoo est entièrement indépendant au niveau des énergies, et nous sommes fiers d'agir pour la préservation de la biodiversité et des ressources de notre belle planète bleue.</p>
          <a href="#"><img class="card-img-top d-none d-sm-block" src="../../public/images/carte/Carte_Zoo.jpg" alt="Carte Zoo Arcadia"></a>
        </div>
        <div class="card-body">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
      <div class="card h-100">
        <div class="card-body main-content">
          ...
          <p class="card-text">Une centaine d’animaux chouchoutés par nos équipes, peuplent le Zoo. Ils vous attendent! Voici toutes les races d'animaux que vous allez pouvoir rencontrer tout au long de votre visite :</p>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
      <div class="card h-100 d-none d-sm-block">
        <div class="card-body main-content">
          ...
          <p class="card-text">Les animaux évoluent dans une zone aménagée pour eux, qui réunit les conditions proches de leur milieu d’origine, afin de contribuer à leur santé morale et physique. Ces habitats sont :</p>
          <div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
      <div class="card h-100 d-none d-sm-block">
        <div class="card-body main-content">
          ...
          <p class="card-text">Notre Zoo va vous faire vivre une expérience dont vous vous souviendrez très longtemps. Pour améliorer encore votre visite, nous proposons plusieurs services :</p>
