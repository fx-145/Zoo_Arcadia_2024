...
class Database {
    ...
    public function __construct() {
        ...
        $this->port = getenv('STACKHERO_MARIADB_PORT') ?: $_ENV['STACKHERO_MARIADB_PORT'];
        ...
        try {
            $this->db = new PDO("mysql:host={$this->host};port={$this->port};dbname={$this->db_name}", $this->user_name, $this->password);
